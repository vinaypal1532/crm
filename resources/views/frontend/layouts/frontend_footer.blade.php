        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>11A/1 Govind Garden,Raisen Road, Govindpura,462023</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <form id="newsForm">
                        @csrf
                        <input class="form-control border-primary w-100 py-3 ps-4 pe-5" type="text" name="email" id="email" placeholder="Your email">
...
<script src="{{ asset('asset/frontend/lib/wow/wow.min.js') }}"></script>
